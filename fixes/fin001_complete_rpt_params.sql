-- =============================================================================
-- AUTO-GENERATED RPT_PARAMS for FIN001 with ALL COLUMN NAMES
-- =============================================================================
...
-- 
-- 1. To hide some columns:
-- "hidden_columns": ["PBC_SUB_ACNT_CODE", "ABAL_SUB_ACNT_CODE"]
--
-- 2. To show only specific columns:
-- "display_columns": ["MAIN_ACNT_NAME", "OP_BAL", "CLO_BAL"]
-- 
-- 3. To change only some column names:
-- Just modify the ones you want in "column_headers" section above
-- 
-- 4. To use original column names:
-- Set "column_headers": {} (empty object)
-- =============================================================================